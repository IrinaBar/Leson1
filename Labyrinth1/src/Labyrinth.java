...
/*    Cell[] getNeighbors(Cell celll){
    ...
    public Cell[] getNeighbors(Cell cell) {
        ...
        if (cell.getColumn() == 0 && cell.getRow() >= 1 && cell.getRow() < height-1) {//первая строка, ряд посередине
        ...
        if (cell.getRow() == 0 && cell.getColumn() >= 1 && cell.getColumn() < height-1) { //первый ряд,строка посередине
            neighbors = new Cell[3];
        ...
        if (cell.getColumn() == 0 && cell.getRow() == 0) { //верхний левый
        ...
        if (cell.getColumn() == 0 && cell.getRow() == width - 1 ) {//верхний правый
            neighbors = new Cell[2];
            Cell c2 = labyrinth[cell.getRow()][cell.getColumn() + 1];
            Cell c4 = labyrinth[cell.getRow() - 1][cell.getColumn()];
            neighbors[0] = c2;
            neighbors[1] = c4;
        }

        if (cell.getRow() == 0 && cell.getColumn() >= height - 1) {//нижний левый
            neighbors = new Cell[2];
            Cell c1 = labyrinth[cell.getRow()][cell.getColumn() - 1];
            Cell c3 = labyrinth[cell.getRow() + 1][cell.getColumn()];
            neighbors[0] = c1;
        ...
        if (cell.getRow() >= width - 1 && cell.getColumn() >= height - 1) {//нижний правый
            neighbors = new Cell[2];
            Cell c1 = labyrinth[cell.getRow()][cell.getColumn() - 1];
            Cell c4 = labyrinth[cell.getRow() - 1][cell.getColumn()];
            neighbors[0] = c1;
        ...
        if (cell.getRow() > 0 && cell.getRow() < width - 1 && cell.getColumn() > 0 && cell.getColumn() < height - 1) {
